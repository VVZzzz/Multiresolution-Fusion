...
struct qt_meta_stringdata_SARibbonCategoryProxy_t {
    QByteArrayData data[1];
    char stringdata0[22];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_SARibbonCategoryProxy_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_SARibbonCategoryProxy_t qt_meta_stringdata_SARibbonCategoryProxy = {
    {
QT_MOC_LITERAL(0, 0, 21) // "SARibbonCategoryProxy"

    },
    "SARibbonCategoryProxy"
};
#undef QT_MOC_LITERAL

static const uint qt_meta_data_SARibbonCategoryProxy[] = {
...
void SARibbonCategoryProxy::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    Q_UNUSED(_o);
    Q_UNUSED(_id);
    Q_UNUSED(_c);
...
const QMetaObject SARibbonCategoryProxy::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_SARibbonCategoryProxy.data,
      qt_meta_data_SARibbonCategoryProxy,  qt_static_metacall, nullptr, nullptr}
};


const QMetaObject *SARibbonCategoryProxy::metaObject() const
{
    return QObject::d_ptr->metaObject ? QObject::d_ptr->dynamicMetaObject() : &staticMetaObject;
}

void *SARibbonCategoryProxy::qt_metacast(const char *_clname)
{
    if (!_clname) return nullptr;
    if (!strcmp(_clname, qt_meta_stringdata_SARibbonCategoryProxy.stringdata0))
        return static_cast<void*>(this);
    return QObject::qt_metacast(_clname);
}

int SARibbonCategoryProxy::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
