...
const QMetaObject SARibbonGalleryGroupModel::staticMetaObject = {
    { &QAbstractListModel::staticMetaObject, qt_meta_stringdata_SARibbonGalleryGroupModel.data,
      qt_meta_data_SARibbonGalleryGroupModel,  qt_static_metacall, nullptr, nullptr}
};
...
QT_MOC_LITERAL(6, 66, 14) // "enableIconText"

    },
    "SARibbonGalleryGroup\0groupTitleChanged\0"
    "\0title\0onItemClicked\0index\0enableIconText"
};
#undef QT_MOC_LITERAL
...
void SARibbonGalleryGroup::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        SARibbonGalleryGroup *_t = static_cast<SARibbonGalleryGroup *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            typedef void (SARibbonGalleryGroup::*_t)(const QString & );
...
const QMetaObject SARibbonGalleryGroup::staticMetaObject = {
    { &QListView::staticMetaObject, qt_meta_stringdata_SARibbonGalleryGroup.data,
      qt_meta_data_SARibbonGalleryGroup,  qt_static_metacall, nullptr, nullptr}
};
